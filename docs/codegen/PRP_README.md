...
- **Observability**: Logging (Axiom), analytics (PostHog), alerts (Slack), and monitoring queries for the feature.
- **Deployment Strategy**: Feature flag configuration, gradual rollout plan, and rollback procedures.
- **Security & Compliance**: HIPAA checklist for PHI handling, security review triggers, and compliance requirements.
...
- **Definition of Done**: Realistic checklist with required (blocking) vs aspirational (nice-to-have) items for startup velocity.

### Post-Launch Iteration

- **Demo & Release Communication**: Demo scripts, in-app help updates, and release notes for user communication.
- **Dependency Tracking**: Upstream blockers, downstream consumers, and external service dependencies.
- **Technical Debt**: Known compromises, future enhancements, and optimization opportunities.
- **Post-Launch Plan**: Week 1 monitoring, month 1 iterations, and long-term roadmap.
