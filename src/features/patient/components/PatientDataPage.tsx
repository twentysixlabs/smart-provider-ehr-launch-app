...
import { useTokenExpiryDisplay } from "../../auth/hooks/useTokenExpiryDisplay";
...
import { extractBloodPressureComponents, roundToTwoDecimalsOrInteger } from "../../fhir/utils/fhirUtils";
                                ...
                                if ((resource as any)?.valueQuantity) {
                                  return (
                                    <div key={index} className="text-sm">
                                      ...
                                      <span className="text-gray-600">
                                        {roundToTwoDecimalsOrInteger((resource as any).valueQuantity.value)}{" "}
